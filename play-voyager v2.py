...
def main():
    ...
    while choice != "0":
        ...
        #ciekawostki dotyczace miejsca w którym jestes
            ...
            print(dict_of_places[voyager_name.location(response = None)].curiosity_list[0])
            
                
            
        #ciekawostki dotyczace miejsca w którym jestes
        elif choice == "3":
            print(dict_of_places[voyager_name.location(response = None)].curiosity_list[1])
        ...
        #wybór miasta do którego chcesz jechać
            ...
            del dict_of_places[voyager_name.location(response = None)]
            ...
            print(dict_of_places[voyager_name.location(response = None)].greeting)
